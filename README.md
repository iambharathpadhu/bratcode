...
> **You're on `step-4-tiered-permissions`**, step 4 of the six-step build.
> A tier map: safe / confirm / blocked. The harness decides what's allowed, not the model.
> The full progression table is on [`main`](../../tree/main#the-six-step-build); jump to what comes next with `bratcode step5` (or `gc5`).
