...
> **You're on `step-2-the-car-shell`**, step 2 of the six-step build.
> A system prompt and a conversation loop, formalized as their own modules. Still zero tools.
> The full progression table is on [`main`](../../tree/main#the-six-step-build); jump to what comes next with `bratcode step3` (or `gc3`).
