...
> **You're on `step-5-persistent-memory`**, step 5 of the six-step build.
> A flat file on disk that survives the process exiting: quit and restart, it still remembers.
> The full progression table is on [`main`](../../tree/main#the-six-step-build); jump to what comes next with `bratcode step6` (or `gc6`).
